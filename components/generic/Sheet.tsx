...
export const SheetOverlay = ({ className, ...props }: ComponentPropsWithoutRef<typeof Dialog.Overlay>) => (
  <Dialog.Overlay
    className={cn(
...
export const SheetTitle = ({ className, ...props }: ComponentPropsWithoutRef<typeof Dialog.Title>) => (
  <Dialog.Title className={cn('text-lg font-semibold text-foreground', className)} {...props} />
);

export const SheetDescription = ({ className, ...props }: ComponentPropsWithoutRef<typeof Dialog.Description>) => (
